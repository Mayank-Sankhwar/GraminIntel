      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Everything you need to manage your farm, at a glance.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div className="lg:col-span-1">
            <AICropSuggestionCard
              ...
              description="Optimal soil moisture and rising regional demand make this the best choice for your current field conditions."
              confidence={94}
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-6 rounded-xl border border-border bg-card/40 flex items-center justify-between hover:border-accent/40 transition-colors cursor-pointer group">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-bold text-foreground">Call Agronomist</h4>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-bold text-foreground">WhatsApp Help</h4>
